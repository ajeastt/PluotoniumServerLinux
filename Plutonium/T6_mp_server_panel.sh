...
# Plutonium T6 Multiplayer server start script for panel environments (Pterodactyl / Calagopus)
...
NAME="${SERVER_NAME:-T6 Multiplayer 1}"
...
# Server config file (MP)
# Prefer SERVER_CONFIG, but accept legacy SERVER_CFG
CFG="${SERVER_CONFIG:-${SERVER_CFG:-dedicated_mp.cfg}}"

# Server port (default MP port 4976)
PORT="${SERVER_PORT:-4976}"

# Game mode (always t6mp for this script)
MODE="${GAME_MODE:-t6mp}"
